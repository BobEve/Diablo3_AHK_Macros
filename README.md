...
##### 魔法师32秒循环双黑人奥陨宏v1.7 for D3 v2.6.7.64160
+ 键位设置：1 原力波、2 御法者、3 电刑、4 陨石、左 护甲、右 冰霜射线、W 强制移动（必需设置）
+ 使用要求：站街攻速 1.54、CDR 不少于55.81%（建议8x4 + 10）、萃取 黄道黑耀石、不带勾玉
+ F1：开启/关闭宏功能（默认开启）
...
+ 注：某些极限情况下，会导致黄道刷新不足，第二发后无法变黑人的情况；所以cdr尽量保证多一条，这样比较稳。cdr在55.81时，要尽早落点，避免在狭窄、怪物较少的地方落点。<br /><br />
